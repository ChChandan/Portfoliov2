...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'An identity-driven Zero Trust security framework integrating Keycloak, OpenZiti, and Flask to deliver secure, segmented, and continuous access control for SMEs.',
    language: 'Python, Flask, Docker',
    url: 'https://github.com/ChChandan/ZeroTrustArchitecture_SME',
  ...
  {
    name: 'IPhone 15 Pro Page Clone',
    description: 'A pixel-perfect clone of the iPhone 15 Pro product page using HTML and CSS, showcasing responsive design and modern web development techniques',
    language: 'React, Tailwind CSS',
    url: 'https://github.com/ChChandan/iPhone15pro',
    tags: ['Web Development', 'Visualization', 'React'],
  },
  {
